...
insert into customer (user_id,email,first_name,last_name,middle_name,password,phone_number,status,username)  values ('CUSTOMER1','niranjanthapa@gmail.com','Niranjan','Thapa','','$2a$10$YfrGSaiDIaIcwWP78wsWiuTlwabcaO5BCPj.Iryf0m4XdidTTjaaK','9810314784','using','niranjan');
...
insert into customer (user_id,email,first_name,last_name,middle_name,password,phone_number,status,username)  values ('CUSTOMER7','nimasherpa@gmail.com','nima','sherpa','tsering','$2a$10$YfrGSaiDIaIcwWP78wsWiuTlwabcaO5BCPj.Iryf0m4XdidTTjaaK','9814314484','using','tseringnima');
