...
insert into customer (user_id,email,first_name,last_name,middle_name,password,phone_number,status,username)  values ('CUSTOMER1','niranjanthapa6441@gmail.com','Niranjan','Thapa','','$2a$10$YfrGSaiDIaIcwWP78wsWiuTlwabcaO5BCPj.Iryf0m4XdidTTjaaK','9810314784','using','niranjan');
insert into customer (user_id,email,first_name,last_name,middle_name,password,phone_number,status,username)  values ('CUSTOMER2','robinkarki@gmail.com','Rabindra','Karki','Jung','$2a$10$YfrGSaiDIaIcwWP78wsWiuTlwabcaO5BCPj.Iryf0m4XdidTTjaaK','9810314484','using','robin');
insert into customer (user_id,email,first_name,last_name,middle_name,password,phone_number,status,username)  values ('CUSTOMER3','ravikhadka@gmail.com','Ravi','Khadka','','$2a$10$YfrGSaiDIaIcwWP78wsWiuTlwabcaO5BCPj.Iryf0m4XdidTTjaaK','9810313784','using','ravi');
insert into customer (user_id,email,first_name,last_name,middle_name,password,phone_number,status,username)  values ('CUSTOMER4','prabeshkhati@gmail.com','Prabesh','Chettri','Khati','$2a$10$YfrGSaiDIaIcwWP78wsWiuTlwabcaO5BCPj.Iryf0m4XdidTTjaaK','9810313284','using','prabesh');
insert into customer (user_id,email,first_name,last_name,middle_name,password,phone_number,status,username)  values ('CUSTOMER5','abhisekhKhadka@gmail.com','ABhisekh','Khadka','','$2a$10$YfrGSaiDIaIcwWP78wsWiuTlwabcaO5BCPj.Iryf0m4XdidTTjaaK','9810214384','using','abhisekh');
insert into customer (user_id,email,first_name,last_name,middle_name,password,phone_number,status,username)  values ('CUSTOMER6','prashannathapa@gmail.com','prashanna','Thapa','','$2a$10$YfrGSaiDIaIcwWP78wsWiuTlwabcaO5BCPj.Iryf0m4XdidTTjaaK','9810224784','using','prashanna');
insert into customer (user_id,email,first_name,last_name,middle_name,password,phone_number,status,username)  values ('CUSTOMER7','nimatseringsherpa@gmail.com','nima','sherpa','tsering','$2a$10$YfrGSaiDIaIcwWP78wsWiuTlwabcaO5BCPj.Iryf0m4XdidTTjaaK','9814314484','using','tseringnima');
insert into customer (user_id,email,first_name,last_name,middle_name,password,phone_number,status,username)  values ('CUSTOMER9','nabinshiwakoti@gmail.com','nabin','shiwakoti','Khati','$2a$10$YfrGSaiDIaIcwWP78wsWiuTlwabcaO5BCPj.Iryf0m4XdidTTjaaK','9814313284','using','nabin');
insert into customer (user_id,email,first_name,last_name,middle_name,password,phone_number,status,username)  values ('CUSTOMER11','nishanbade@gmail.com','nishan','bade','','$2a$10$YfrGSaiDIaIcwWP78wsWiuTlwabcaO5BCPj.Iryf0m4XdidTTjaaK','9814314784','using','nishan');
insert into customer (user_id,email,first_name,last_name,middle_name,password,phone_number,status,username)  values ('CUSTOMER13','rupashresthagmail.com','rupa','shrestha','','$2a$10$YfrGSaiDIaIcwWP78wsWiuTlwabcaO5BCPj.Iryf0m4XdidTTjaaK','9814313784','using','rupa');
insert into customer (user_id,email,first_name,last_name,middle_name,password,phone_number,status,username)  values ('CUSTOMER15','sudikshyatwayana@gmail.com','sudikshya','twayana','','$2a$10$YfrGSaiDIaIcwWP78wsWiuTlwabcaO5BCPj.Iryf0m4XdidTTjaaK','9814214384','using','sudikshya');
